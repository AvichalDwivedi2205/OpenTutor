  ...
  const editor = useEditor({
    ...
    extensions: [
      ...
      Link.configure({
        ...
        HTMLAttributes: {
          class:
            "text-sky-600 underline hover:text-sky-800 dark:text-sky-400 dark:hover:text-sky-300",
        },
      }),
      // Styling extensions
      TextStyle,
      ...
      CodeBlock.configure({
        ...
        HTMLAttributes: {
          class:
            "rounded-lg bg-slate-100 dark:bg-slate-800 p-4 font-mono text-sm",
        },
      }),
      // Image extension
      Image.configure({
          ...
          render: () => {
            ...
            return {
              onStart: (props) => {
                ...
                popup = Array.isArray(popupInstances)
                  ? (popupInstances[0] ?? null)
                  : popupInstances;
              },
    ...
    editorProps: {
      attributes: {
        class:
          "prose prose-sm sm:prose-base lg:prose-lg xl:prose-2xl mx-auto focus:outline-none min-h-[500px] p-6 max-w-none",
        ...
        <div className="flex flex-wrap items-center gap-1 p-2">
          ...
          <div className="flex items-center gap-1 border-r border-slate-200 pr-2 dark:border-slate-700">
            <div className="relative">
              <ToolbarButton onClick={handleColorPrompt} title="Text Color">
